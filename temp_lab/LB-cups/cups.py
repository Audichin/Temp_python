...
def main() -> None:
    ...
    for _ in range(n):
        # FIXME 2 : read each line and split it into two variables
        part1, part2 = input().split
        # FIXME 3 : add radius (int) as a key and color as a value to cups
    ...
    # FIXME 5: print the colors in ans one line at a time
